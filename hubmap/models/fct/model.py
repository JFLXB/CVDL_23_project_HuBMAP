...
class FCT(nn.Module):
    def __init__(self, in_channels: int, num_classes: int, verbose: bool = False):
        ...
        # model
        self.block_1 = Block_encoder_bottleneck("first", in_channels, filters[0], att_heads[0], dpr[0])
        self.block_2 = Block_encoder_bottleneck("second", filters[0], filters[1], att_heads[1], dpr[1], in_channels)
        self.block_3 = Block_encoder_bottleneck("third", filters[1], filters[2], att_heads[2], dpr[2], in_channels)
        self.block_4 = Block_encoder_bottleneck("fourth", filters[2], filters[3], att_heads[3], dpr[3], in_channels)
