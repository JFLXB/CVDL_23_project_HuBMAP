...
parser.add_argument(
    "--add-background", action="store_true", help="Add background class to the target mask",
)
...
load_annotated_data = make_annotated_loader(train_transformations, test_transformations, with_background=WITH_BACKGROUND)
